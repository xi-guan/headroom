...
## [0.27.0](https://github.com/xi-guan/headroom/compare/v0.26.0...v0.27.0) (2026-06-19)


### Features

* add Copilot BYOK provider wrapper utilities and CLI support ([#1041](https://github.com/xi-guan/headroom/issues/1041)) ([e67ee2a](https://github.com/xi-guan/headroom/commit/e67ee2af658bce35fb4c71b45a0c5b294d7dcfdc))
* add dashboard agent usage stats ([#814](https://github.com/xi-guan/headroom/issues/814)) ([6d3f39f](https://github.com/xi-guan/headroom/commit/6d3f39f213f4eb2d1c6c814b34e1bf6fe2a5c959))
* add differential network capture harness ([#761](https://github.com/xi-guan/headroom/issues/761)) ([11ab5f8](https://github.com/xi-guan/headroom/commit/11ab5f83a1ccd617a2608349a42feff7f7e72b98))
* add lean-ctx context tool support ([4b06179](https://github.com/xi-guan/headroom/commit/4b061792b29f776f36831530ba6fdbfd6d71ad0b))
* add light mode for dashboard ([#834](https://github.com/xi-guan/headroom/issues/834)) ([c425893](https://github.com/xi-guan/headroom/commit/c425893d123e67c62ee20ff64ae350eb4ea56477))
* add OAuth2 client-credentials upstream-auth proxy extension ([#778](https://github.com/xi-guan/headroom/issues/778)) ([#784](https://github.com/xi-guan/headroom/issues/784)) ([eb2e50f](https://github.com/xi-guan/headroom/commit/eb2e50feb26bacadf8812d6e608a458a990096b9))
* Add support for Mistral Vibe CLI ([#935](https://github.com/xi-guan/headroom/issues/935)) ([0932b8b](https://github.com/xi-guan/headroom/commit/0932b8bef4db9109665382b6d7c079a368f08d52))
* add Vertex AI proxy routing ([#793](https://github.com/xi-guan/headroom/issues/793)) ([3c77e52](https://github.com/xi-guan/headroom/commit/3c77e52ce431210e6045671cf5f7c66c79f90a32))
* attribute reread waste to over-compression via marker check ([#901](https://github.com/xi-guan/headroom/issues/901)) ([f928576](https://github.com/xi-guan/headroom/commit/f9285766dda77b116c7834165849264e55339720))
* **bedrock:** cross-region + Converse compression; bundle proxy binary in images ([#999](https://github.com/xi-guan/headroom/issues/999)) ([0dc2e1c](https://github.com/xi-guan/headroom/commit/0dc2e1cb3f7278332d450644831007316d6ac18c))
* **ci:** X2 — PR-time release dry-run via path-filtered pull_request trigger ([7a06355](https://github.com/xi-guan/headroom/commit/7a063554ce03c04cbacd45d548f513f99dcde95a))
* **ci:** X2 — PR-time release dry-run via path-filtered pull_request trigger ([b9f84fa](https://github.com/xi-guan/headroom/commit/b9f84fa815a2696a85ed3f430d52b6ccaf36ac82))
* **cli:** add headroom doctor setup diagnostics ([#926](https://github.com/xi-guan/headroom/issues/926)) ([e45cf4e](https://github.com/xi-guan/headroom/commit/e45cf4e0618b4de02608f68c502ac4cf1270eb84))
* **cli:** add headroom update command and release banner ([#1088](https://github.com/xi-guan/headroom/issues/1088)) ([26be2c3](https://github.com/xi-guan/headroom/commit/26be2c39cb8a3c23edc08516f01cf91fad33c117))
* **cli:** comprehensive help text, validation, and exception handling improvements ([#640](https://github.com/xi-guan/headroom/issues/640)) ([028efab](https://github.com/xi-guan/headroom/commit/028efabb4e611d77118baefb8ffdd13b0edc4fc5))
* compression extraction — Rust knob exposure, CCR hardening, traffic audits ([#818](https://github.com/xi-guan/headroom/issues/818)) ([b7be381](https://github.com/xi-guan/headroom/commit/b7be3814f1d38375bc27901272bbe919e6b35940))
* compression safety rails — error-output protection, pipeline circuit breaker, library inflation guard ([#851](https://github.com/xi-guan/headroom/issues/851)) ([c0cadcc](https://github.com/xi-guan/headroom/commit/c0cadccff98e572f126185f371e4de9e241b12e0))
* **copilot:** GitHub Copilot subscription mode through Headroom ([f4dff9b](https://github.com/xi-guan/headroom/commit/f4dff9b4885b5c62d79396bbb0847ae3e39a9bd9))
* **dashboard:** per-model savings breakdown and expected-vs-actual cost on historical charts ([#807](https://github.com/xi-guan/headroom/issues/807)) ([34dafe6](https://github.com/xi-guan/headroom/commit/34dafe69d907c9a2971abc0d801ff9bfa498b3a8))
* **dashboard:** surface compression-vs-cache net impact in Prefix Cache panel ([#913](https://github.com/xi-guan/headroom/issues/913)) ([2a4d300](https://github.com/xi-guan/headroom/commit/2a4d300841c8cbb55435f821fc2d01c3b3b43a59))
* detect re-served tool results as over-compression waste signal ([#854](https://github.com/xi-guan/headroom/issues/854)) ([5f1d88a](https://github.com/xi-guan/headroom/commit/5f1d88ad2701ed186df93d8e2a3980f0329d9dbb))
* **evals:** add zero-cost tool schema compaction integrity eval ([#817](https://github.com/xi-guan/headroom/issues/817)) ([53a08c6](https://github.com/xi-guan/headroom/commit/53a08c63bf56a76d4fb7b649e37c8e62b0b4cebf))
* **evals:** adversarial-input robustness grid for compressors ([#918](https://github.com/xi-guan/headroom/issues/918)) ([5939004](https://github.com/xi-guan/headroom/commit/5939004185a1f9b4ef2e88ee3e72a10e5c8fa4a6))
* gated Markdown-KV compaction formatter (serialization-aware output) ([#859](https://github.com/xi-guan/headroom/issues/859)) ([06b2625](https://github.com/xi-guan/headroom/commit/06b2625b17b0b032f688d321c6aa30ae3f2b7d96))
* **kompress:** warn on unrecognized HEADROOM_KOMPRESS_BACKEND + document backend selection ([#204](https://github.com/xi-guan/headroom/issues/204)) ([6367d0b](https://github.com/xi-guan/headroom/commit/6367d0b7228f53b29bbd20f55c1729476ba5ea68))
* measure and surface token throughput (tokens/sec) through the proxy ([#983](https://github.com/xi-guan/headroom/issues/983)) ([0d89c67](https://github.com/xi-guan/headroom/commit/0d89c674cd3522c0a46e3df9b98426e59b337b10))
* **memory:** add opt-in Apple-GPU (MPS) embedding runtime ([#766](https://github.com/xi-guan/headroom/issues/766)) ([c71592d](https://github.com/xi-guan/headroom/commit/c71592d4214adf1022e4c608518ae0c3ac4aa5e9))
* net-cost cache mutation formula on CompressionPolicy ([#856](https://github.com/xi-guan/headroom/issues/856) P1) ([#857](https://github.com/xi-guan/headroom/issues/857)) ([d5f5802](https://github.com/xi-guan/headroom/commit/d5f58026e2a882bc508acfbddfc9d472100d6e16))
* output-token reduction — verbosity shaper, per-user learning, counterfactual savings ([#965](https://github.com/xi-guan/headroom/issues/965)) ([a99dc61](https://github.com/xi-guan/headroom/commit/a99dc61424df4c7b22c37986fb8dfc648f3ac3b8))
* **parser:** detect re-issued identical tool calls as reread waste ([#909](https://github.com/xi-guan/headroom/issues/909)) ([7d4ae86](https://github.com/xi-guan/headroom/commit/7d4ae86ec0bb09efff765422b89db587b050cd08))
* **perf:** add --format {text,json,csv} to `headroom perf` ([#648](https://github.com/xi-guan/headroom/issues/648)) ([9fe4886](https://github.com/xi-guan/headroom/commit/9fe4886cf6b612452f7271d3204872f804074c1f))
* **plugins:** Hermes agent headroom_retrieve plugin ([#824](https://github.com/xi-guan/headroom/issues/824)) ([058bced](https://github.com/xi-guan/headroom/commit/058bcedab838f3b34ac8e38853e1924329efd820))
* **policy:** batch deep edits through one cache-bust ([#856](https://github.com/xi-guan/headroom/issues/856) P3a) ([#1015](https://github.com/xi-guan/headroom/issues/1015)) ([c2e52fe](https://github.com/xi-guan/headroom/commit/c2e52fe7439b464edaee83827ca7d8c8091d7e9a))
* **policy:** consume net-cost mutation gate in ContentRouter ([#856](https://github.com/xi-guan/headroom/issues/856) P2) ([#905](https://github.com/xi-guan/headroom/issues/905)) ([553ade4](https://github.com/xi-guan/headroom/commit/553ade4ec66793c1707df6a95888ca2c1506c0b1))
* **policy:** decay P_alive from idle time near cache TTL ([#856](https://github.com/xi-guan/headroom/issues/856) P3b) ([#1028](https://github.com/xi-guan/headroom/issues/1028)) ([fe4f9ee](https://github.com/xi-guan/headroom/commit/fe4f9ee478f50a84190a2d44de2b9fbf24272acf))
* probe-based retention scoring of recorded compression events ([#862](https://github.com/xi-guan/headroom/issues/862)) ([c2106cb](https://github.com/xi-guan/headroom/commit/c2106cbdabb905e1980c6694000c220a5042171c))
* **proxy:** add --exclude-tools flag + HEADROOM_EXCLUDE_TOOLS env var ([1058043](https://github.com/xi-guan/headroom/commit/10580439bb4227a3f6f375439b0baae60db2f288))
* **proxy:** add --exclude-tools flag + HEADROOM_EXCLUDE_TOOLS env var ([93cf8af](https://github.com/xi-guan/headroom/commit/93cf8af0e0c6b6b7fee0bcfe5b57a514c294a898))
* **proxy:** add CLI opt-outs for CCR injection (compression-only mode) ([#823](https://github.com/xi-guan/headroom/issues/823)) ([693d9d2](https://github.com/xi-guan/headroom/commit/693d9d20e2b2d9bfce3a0c48314850ee77ff8af3))
* **proxy:** add client (harness) identification — per-harness analytics across every handler ([96a674f](https://github.com/xi-guan/headroom/commit/96a674f1b9c7d0b251478bb53541f8fbd6859e1f))
* **proxy:** attribute savings history rollups per provider ([#791](https://github.com/xi-guan/headroom/issues/791)) ([0b8b8d9](https://github.com/xi-guan/headroom/commit/0b8b8d92de3bd5e0301eadedacfb4b1d20a8de7f))
* **proxy:** cc-switch reconciler — keep Headroom in the request path alongside cc-switch ([#1030](https://github.com/xi-guan/headroom/issues/1030)) ([e8fc8a0](https://github.com/xi-guan/headroom/commit/e8fc8a0d18a551bad572ec21aa92a424748683a5))
* **proxy:** compress AWS Bedrock InvokeModel requests via configurable upstream ([#720](https://github.com/xi-guan/headroom/issues/720)) ([7edb27a](https://github.com/xi-guan/headroom/commit/7edb27ab2496b070cbe835b31eb2f828798ddfaa))
* **proxy:** hot-reload live env knobs so a reused proxy picks them up without a restart ([#1090](https://github.com/xi-guan/headroom/issues/1090)) ([6904d47](https://github.com/xi-guan/headroom/commit/6904d47a01e7be496e21d8ebcf34739db5c3b7dd))
* **proxy:** log compressed messages alongside original request ([#261](https://github.com/xi-guan/headroom/issues/261)) ([2269e40](https://github.com/xi-guan/headroom/commit/2269e40bde7e1b9fb0620bd2cec9e33a92834080))
* **proxy:** make COMPRESSION_TIMEOUT_SECONDS configurable via env ([#946](https://github.com/xi-guan/headroom/issues/946)) ([#991](https://github.com/xi-guan/headroom/issues/991)) ([addebdb](https://github.com/xi-guan/headroom/commit/addebdb29c3b4a877ed46553d9b0c0a128d62cef))
* **proxy:** per-project savings breakdown on the dashboard (claude, codex, aider, copilot, cursor) ([#803](https://github.com/xi-guan/headroom/issues/803)) ([914a60a](https://github.com/xi-guan/headroom/commit/914a60a2b07caad8488c1e19a5465726b95f83d3))
* **proxy:** show resolved upstream API targets in startup banner ([#586](https://github.com/xi-guan/headroom/issues/586)) ([8dbe7ad](https://github.com/xi-guan/headroom/commit/8dbe7ad41b3a1d33c01874be5c1cbc68a5e68111)), closes [#583](https://github.com/xi-guan/headroom/issues/583)
* **relevance:** weight BM25 score_batch by corpus IDF ([#646](https://github.com/xi-guan/headroom/issues/646)) ([88177bd](https://github.com/xi-guan/headroom/commit/88177bd7a680490ac85d244c5fff90f21a3be27c))
* support CLAUDE_CODE_USE_FOUNDRY and custom upstream gateways ([#726](https://github.com/xi-guan/headroom/issues/726)) ([d90cdce](https://github.com/xi-guan/headroom/commit/d90cdce3b69bbf27e0f5feea461766a9d797cf7e))
* support Python 3.14+ via pyo3 abi3 stable ABI ([#516](https://github.com/xi-guan/headroom/issues/516)) ([19eac8e](https://github.com/xi-guan/headroom/commit/19eac8e00dc9e3911f3afe8e8e5dcc9e00346baa))
* switch Kompress default to kompress-v2-base with weight-only int8 ONNX ([#799](https://github.com/xi-guan/headroom/issues/799)) ([74392b2](https://github.com/xi-guan/headroom/commit/74392b238e4f76fa061e673d1415fc7fa2830011))
* **transforms:** attribute read_lifecycle + smart_crush tags ([#249](https://github.com/xi-guan/headroom/issues/249)) ([8f37426](https://github.com/xi-guan/headroom/commit/8f374263d3971c072b5c977375c873864fb05763))
* **vertex:** turnkey Claude Code + Vertex compression (+ fixes from the Vertex review) ([#1113](https://github.com/xi-guan/headroom/issues/1113)) ([0e05915](https://github.com/xi-guan/headroom/commit/0e0591506c3f120b96cdc98054114d9ec1771f67))


### Bug Fixes

* add Codex wire debug and WS usage metrics ([7c94e72](https://github.com/xi-guan/headroom/commit/7c94e728410d8784ecdcddb3d7c9bd6dc079e376))
* add Codex wire debug and WS usage metrics ([2b331e2](https://github.com/xi-guan/headroom/commit/2b331e297a02b0a685b9f3fdf2432eefc3cdcccd))
* add Kompress backend and thread controls ([a2ea964](https://github.com/xi-guan/headroom/commit/a2ea9648a4380fee97a4ad2b98ed0197d8ea03f0))
* align docs and prune dead compatibility surfaces ([359e8c9](https://github.com/xi-guan/headroom/commit/359e8c9a5b6f4dfc0c4126affd3308893da4c421))
* **anthropic:** CCR exception must re-raise, not silently swallow ([#838](https://github.com/xi-guan/headroom/issues/838)) ([8db5efc](https://github.com/xi-guan/headroom/commit/8db5efc6f9f6de59e9d55cbcd63b75c37a81a26e))
* **anthropic:** strip styled Claude model ids ([#651](https://github.com/xi-guan/headroom/issues/651)) ([0c5c89d](https://github.com/xi-guan/headroom/commit/0c5c89d05cefabaa833e54decfdeb677edacc0d7))
* **anyllm:** forward openai api_base/api_key to the any-llm backend ([#942](https://github.com/xi-guan/headroom/issues/942)) ([#954](https://github.com/xi-guan/headroom/issues/954)) ([a7ee8a6](https://github.com/xi-guan/headroom/commit/a7ee8a60a7ac28a8adcc7a7fa83a04a59afe41d5))
* batch and guard Kompress inference ([b946a44](https://github.com/xi-guan/headroom/commit/b946a44c44a74ec601fd9fb4b97a4199b6c9b792))
* **bedrock:** apply rustfmt to header_value_preview tests ([42ff8af](https://github.com/xi-guan/headroom/commit/42ff8afa90c29a11079256bbe2d4a96878d708c6))
* **bedrock:** use floor_char_boundary to avoid UTF-8 slice panic in header preview ([399cb32](https://github.com/xi-guan/headroom/commit/399cb32fa475ebbc0e6790024f77675d6b72f4fd))
* **bedrock:** use floor_char_boundary to avoid UTF-8 slice panic in header preview ([82468e4](https://github.com/xi-guan/headroom/commit/82468e4e99e6013ab9a44df2e2f12c9352bbc18f)), closes [#415](https://github.com/xi-guan/headroom/issues/415)
* **bedrock:** use is_char_boundary loop instead of floor_char_boundary (MSRV 1.80) ([b784f40](https://github.com/xi-guan/headroom/commit/b784f400c109b51352825d68341a2801a29123d6))
* **build:** shrink Rust extension wheels — strip + thin-LTO + single codegen unit ([d73cbd6](https://github.com/xi-guan/headroom/commit/d73cbd6b0aea20a0e99d29e6c775f26d27f59eb5))
* **build:** shrink Rust extension wheels (strip + thin-LTO + single codegen unit) ([ec8e208](https://github.com/xi-guan/headroom/commit/ec8e2080f3231353f11589016a191dd02e100b98))
* **cache:** guard None exemplar embeddings in dynamic detector ([#950](https://github.com/xi-guan/headroom/issues/950)) ([1ec9320](https://github.com/xi-guan/headroom/commit/1ec93208883f2606cc7ec3db0b8bd8e071646984))
* **cache:** name the missing piece in semantic detector guard ([#1018](https://github.com/xi-guan/headroom/issues/1018)) ([3b0bcee](https://github.com/xi-guan/headroom/commit/3b0bceecf4281eb34112de8dd546d4a58beb3fcc))
* **ccr:** accept 12-char SmartCrusher hashes in tool injection ([#1095](https://github.com/xi-guan/headroom/issues/1095)) ([#1141](https://github.com/xi-guan/headroom/issues/1141)) ([9f7f3ad](https://github.com/xi-guan/headroom/commit/9f7f3adfea03710d5e67c4c630b3c8061ff6d161))
* **ccr:** key Rust search/diff/log markers with explicit_hash ([#852](https://github.com/xi-guan/headroom/issues/852)) ([bfcb07d](https://github.com/xi-guan/headroom/commit/bfcb07d78ea7eba539a65b11e100ec23b336d8d1))
* **ccr:** make retrieval TTL configurable ([#715](https://github.com/xi-guan/headroom/issues/715)) ([2533f77](https://github.com/xi-guan/headroom/commit/2533f7703ee261dc35767b11e46b8eab6e0c454d))
* **ccr:** scope proactive expansion by workspace (cross-project leak) ([197601b](https://github.com/xi-guan/headroom/commit/197601bc64ee72e786bf6b94cd90efcac4269bcf))
* **ccr:** scope proactive expansion by workspace (cross-project leak) ([1bc163f](https://github.com/xi-guan/headroom/commit/1bc163f5bc1a8422f9ad659061e1fdd8cfeb077b))
* **ccr:** skip CCR when model calls headroom_retrieve alongside user tools ([#839](https://github.com/xi-guan/headroom/issues/839)) ([30078f8](https://github.com/xi-guan/headroom/commit/30078f8465fb6bb78a5a9c394b75e60cd3c4eeec))
* **ccr:** use shared compression store ([#875](https://github.com/xi-guan/headroom/issues/875)) ([249af6c](https://github.com/xi-guan/headroom/commit/249af6cc7b379678e60da3e98e552368632fd4f4))
* **ci:** check out repo in PR Governance label job ([#1021](https://github.com/xi-guan/headroom/issues/1021)) ([4558bc2](https://github.com/xi-guan/headroom/commit/4558bc2465e52d575070e5a0d6312cd400c8aee1))
* **ci:** correct comments, timeouts, and pip reliability in native e2e workflows ([#878](https://github.com/xi-guan/headroom/issues/878)) ([b716c8c](https://github.com/xi-guan/headroom/commit/b716c8c2ee7ccc68dd1b9294760db1af866843f2))
* **ci:** force-link glibc shim with -Wl,-u for aarch64 ([39cb7c4](https://github.com/xi-guan/headroom/commit/39cb7c4dc4102a9e14ecaf9c35deb6bd3186830b))
* **ci:** force-link glibc shim with -Wl,-u so aarch64 wheel includes it ([820e66c](https://github.com/xi-guan/headroom/commit/820e66cae65723a7691f7b79707a6f077ac266f0))
* **ci:** glibc shim — drop alias attribute, forward-declare strtol ([af0a960](https://github.com/xi-guan/headroom/commit/af0a9604ee5503d1e7b89e8cf41224a306568fce))
* **ci:** glibc shim — drop alias attribute, forward-declare strtol ([6b15acc](https://github.com/xi-guan/headroom/commit/6b15acc3b572381260e9c3f068bc5c43bb9eda18))
* **ci:** include NOTICE in sdist + assert License-File metadata matches tarball ([fc6b0a0](https://github.com/xi-guan/headroom/commit/fc6b0a0917063df89058d4d01292f43667656c8f))
* **ci:** include NOTICE in sdist + assert License-File metadata matches tarball ([183d51c](https://github.com/xi-guan/headroom/commit/183d51c8a860a5ca8d00c091df89c398ffb0425e))
* **ci:** make PR governance advisory ([#1047](https://github.com/xi-guan/headroom/issues/1047)) ([74dff94](https://github.com/xi-guan/headroom/commit/74dff94fb8580426f5713991be71df94c4f31598))
* **ci:** pin cosign-installer to v3 (v4 does not exist) ([#774](https://github.com/xi-guan/headroom/issues/774)) ([199d693](https://github.com/xi-guan/headroom/commit/199d693f98ecd72d80181c8fee8422b6b64651a2))
* **ci:** pypi publish skip-existing to unblock idempotent re-runs ([f94a9d2](https://github.com/xi-guan/headroom/commit/f94a9d22bace56af115bb48c38f4539a9bb4a5f4))
* **ci:** pypi publish skip-existing to unblock idempotent re-runs ([6a191b4](https://github.com/xi-guan/headroom/commit/6a191b405b5c9bdbcdab4eb1250bea9fa295f18f))
* **ci:** rebuild sdist on the renamed wheel-matrix host ([31bd9f7](https://github.com/xi-guan/headroom/commit/31bd9f78e23a6de20cdc318dc26cd774a62d073b))
* **ci:** rebuild sdist on the renamed wheel-matrix host ([75576da](https://github.com/xi-guan/headroom/commit/75576dae2bca18610b870b2706c6b54e007dda13))
* **ci:** replace ls with find in smoke-import wheel discovery ([3e78421](https://github.com/xi-guan/headroom/commit/3e784212673a6ffc1b82bcb3f478998c6ff8433b))
* **ci:** restore green lint gate on main ([fe50f9d](https://github.com/xi-guan/headroom/commit/fe50f9daed35151134f79b767733d4be8093e325))
* **ci:** skip smoke OpenAI eval cleanly when OPENAI_API_KEY secret unset ([a281de6](https://github.com/xi-guan/headroom/commit/a281de6bb0279c05a2b44cc868bde9a0428ba82f))
* **ci:** smoke-import wheels on customer-representative envs before publish (X1) ([596212b](https://github.com/xi-guan/headroom/commit/596212b428ba2019885b49381ffdf9cb309ec8e3))
* **ci:** stage smoke-import script as host file (broke main post-[#387](https://github.com/xi-guan/headroom/issues/387)) ([7fe2d1e](https://github.com/xi-guan/headroom/commit/7fe2d1e5b632c3e5424f5364baef0ef8af6510a4))
* **ci:** stage smoke-import script as host file (broke main) ([e536d9b](https://github.com/xi-guan/headroom/commit/e536d9b1801652ff6d4b9bce9683f155029b23c7))
* **ci:** update sdist license-packaging invariant test to match new shape ([cd89a82](https://github.com/xi-guan/headroom/commit/cd89a8297ae55fe26343fc101b695953f07969de))
* **ci:** update sdist license-packaging invariant test to match new shape ([37c0df2](https://github.com/xi-guan/headroom/commit/37c0df23b6cc7bf3e1fbc4f7ad67499a61eb539e))
* **ci:** update tests to assert absence of requires_openai_auth (bug 3, [#406](https://github.com/xi-guan/headroom/issues/406)) ([4071d57](https://github.com/xi-guan/headroom/commit/4071d571345c5a88df56eac5ad975200831e9b7d))
* **ci:** X1 — smoke-import wheels on customer-representative envs before publish ([4745219](https://github.com/xi-guan/headroom/commit/4745219901003be6607df2219e4ce672187b8f27))
* clear CI mypy + rust test failures introduced in eaf5980 ([17ffae0](https://github.com/xi-guan/headroom/commit/17ffae0cd8e4498bf60f4fa5a36521905f9fb151))
* **cli:** G1 remediation — non-string clobber, per-model systemMessage, openhands gate ([ea1976e](https://github.com/xi-guan/headroom/commit/ea1976e37a5147ecf37dbf5ffe4af5c2f2d1be6a))
* **cli:** proxy/perf/wrap UX cleanup + perf --hours correctness ([9ff28e9](https://github.com/xi-guan/headroom/commit/9ff28e9803eaba3c1be9c20924d7b34d98f507b0))
* **cli:** proxy/perf/wrap UX cleanup + perf --hours correctness ([265554d](https://github.com/xi-guan/headroom/commit/265554d4adee7fbf03234a6de832293dec95f811))
* **cli:** resolve duplicate --code-aware flag breaking proxy import ([5dd2ac5](https://github.com/xi-guan/headroom/commit/5dd2ac5e516b9f429648ca5a48be9bb1a6bacb0b))
* **cli:** wrap CLI breadth — cline, continue, goose, openhands ([8625f80](https://github.com/xi-guan/headroom/commit/8625f8075ed75d2a002f6ba357697de0fa1ec434))
* **cli:** wrap subcommands for cline, continue, goose, openhands ([c375fa1](https://github.com/xi-guan/headroom/commit/c375fa156dd0434256805f274c07be4f45db9814))
* Codex ws cancel logging ([73b0e56](https://github.com/xi-guan/headroom/commit/73b0e56e970c6f805a1d174f50b886000372cdb2))
* **codex:** auto-enable fail-open on compression timeout in headroom wrap codex ([#531](https://github.com/xi-guan/headroom/issues/531)) ([5f5f261](https://github.com/xi-guan/headroom/commit/5f5f261a035d12d069eb212eb75c472e2c9edeff))
* **codex:** bug 3 — strip requires_openai_auth, restore consistent openai_base_url injection ([6c4ddc8](https://github.com/xi-guan/headroom/commit/6c4ddc824e074245ffd6ea8002a068cb108f27fb))
* **codex:** compute waste signals on the OpenAI Responses path ([#898](https://github.com/xi-guan/headroom/issues/898)) ([b9e2761](https://github.com/xi-guan/headroom/commit/b9e27614c613a1e5f97eb51af74d3c796fb1ab18))
* **codex:** drop env_key from provider blocks to preserve subscription auth ([32f499c](https://github.com/xi-guan/headroom/commit/32f499cbba4c370865105a55748a365294ec5815))
* **codex:** fail open for proxy compression timeout ([e8ecd08](https://github.com/xi-guan/headroom/commit/e8ecd0882990e464f9b4a7d2041ce86863931e83))
* **codex:** inject openai_base_url in init and persistent-install paths ([bf1e31b](https://github.com/xi-guan/headroom/commit/bf1e31b27c64ad9400d2997ce1f70692ebb408d0))
* **codex:** keep init model_provider at config root ([#260](https://github.com/xi-guan/headroom/issues/260)) ([304dcc7](https://github.com/xi-guan/headroom/commit/304dcc78047bc744fc2f7656b484ec54dc271354))
* **codex:** keep init model_provider at config root ([#260](https://github.com/xi-guan/headroom/issues/260)) ([849b46d](https://github.com/xi-guan/headroom/commit/849b46de5934a88369af2fd7f7d52e9af0536a7e))
* **codex:** poll /wham/usage for subscription limits (handshake no longer sends x-codex-* headers) ([#924](https://github.com/xi-guan/headroom/issues/924)) ([8c00f71](https://github.com/xi-guan/headroom/commit/8c00f7103cf0288991d703cc002ac354e6266534))
* **codex:** PR health label check state ([#986](https://github.com/xi-guan/headroom/issues/986)) ([99c874d](https://github.com/xi-guan/headroom/commit/99c874d4233ec2d35c5c12a709ba32fd2fd96f3d))
* **codex:** respect CODEX_HOME for wrap config ([#731](https://github.com/xi-guan/headroom/issues/731)) ([96abf38](https://github.com/xi-guan/headroom/commit/96abf38b0972adf5e5c66f9a49aa9d9f951b1aa0))
* **codex:** restore openai_base_url top-level injection for subscription routing ([d54c5b6](https://github.com/xi-guan/headroom/commit/d54c5b6a5840fabf0d28079fe67fb0347f016fbb))
* **codex:** retag thread providers so history menu stays whole across the proxy boundary ([#1034](https://github.com/xi-guan/headroom/issues/1034)) ([74ae781](https://github.com/xi-guan/headroom/commit/74ae7816444ae972b55f3da0ff5e28c8638ab4f3))
* **codex:** strip requires_openai_auth and openai_base_url injection (bug 3, [#406](https://github.com/xi-guan/headroom/issues/406)) ([09b8510](https://github.com/xi-guan/headroom/commit/09b851001bf6a2e6ccc34478e42f54c87ddaf5d3))
* **codex:** write canonical hooks feature flag and migrate deprecated codex_hooks ([#743](https://github.com/xi-guan/headroom/issues/743)) ([dff6a19](https://github.com/xi-guan/headroom/commit/dff6a19946b8f96bb8b16fa945b69a1ed09709af))
* complete /v1/responses compression telemetry, multi-frame WS, frozen-count cap ([89f7b6c](https://github.com/xi-guan/headroom/commit/89f7b6c2dd0f3503312490b2052f534e76c01ac3))
* Compress Codex Responses payloads ([d90d2ca](https://github.com/xi-guan/headroom/commit/d90d2caed3b1c3199dd89714a7f0a330b23db59f))
* **compression:** convert tree-sitter byte offsets to char offsets ([#892](https://github.com/xi-guan/headroom/issues/892)) ([b1f700f](https://github.com/xi-guan/headroom/commit/b1f700fc275bf1d7e9461b61a9ebfdb1fba19620))
* **compression:** correct JSON array item counting and entropy gate ([#887](https://github.com/xi-guan/headroom/issues/887)) ([d6f0f0f](https://github.com/xi-guan/headroom/commit/d6f0f0f64269bfbdf36070cb304703c606c64b72))
* **compression:** keep container bodies compressible in code handler ([#890](https://github.com/xi-guan/headroom/issues/890)) ([16ed73b](https://github.com/xi-guan/headroom/commit/16ed73bca68e602a86a385480d484c3a60025b8c))
* **compression:** measure short-value threshold on payload, not token ([#889](https://github.com/xi-guan/headroom/issues/889)) ([65b0e8c](https://github.com/xi-guan/headroom/commit/65b0e8c58dbbc0b77e4b7159b279287979767c4c))
* **compression:** use thread-local tree-sitter parsers in code handler ([#893](https://github.com/xi-guan/headroom/issues/893)) ([6cdb846](https://github.com/xi-guan/headroom/commit/6cdb8462000d9610b5d15f6c7c45adb787bfec1e))
* **content_router:** guard against empty compression output causing Anthropic 400 ([#771](https://github.com/xi-guan/headroom/issues/771)) ([2f9ff07](https://github.com/xi-guan/headroom/commit/2f9ff07e6caef0fe32d00ece6266a476eecff5a3))
* **content-router,proxy:** cache-safe text-block compression and online streaming usage ([ecb3e00](https://github.com/xi-guan/headroom/commit/ecb3e00451f5fd62a2be9d924996c2f075a3de2d))
* **content-router,proxy:** cache-safe text-block compression and online streaming usage ([79baee0](https://github.com/xi-guan/headroom/commit/79baee082f894cf0c467468eed1ae2fed04f37e6))
* **content-router,proxy:** compress text blocks + close DeepSeek metrics gaps ([d322e6d](https://github.com/xi-guan/headroom/commit/d322e6df1fc0f949469242488c5c0080beb206a1))
* **content-router,proxy:** compress text blocks + close DeepSeek metrics gaps ([d955abb](https://github.com/xi-guan/headroom/commit/d955abb1d65a14e07b5c6a915cafc12ddb12ace7))
* **content-router:** honor target_ratio in compression cache + add proxy --target-ratio flag ([#1108](https://github.com/xi-guan/headroom/issues/1108)) ([8894ee0](https://github.com/xi-guan/headroom/commit/8894ee0c18e6dfe858cf0034ec424fd0768a1334))
* **copilot:** deterministic subscription token handoff to the proxy ([72da461](https://github.com/xi-guan/headroom/commit/72da46121726074515e0c1eb9745498457a1a8d5))
* **copilot:** restore generic endpoint for non-subscription OAuth ([#610](https://github.com/xi-guan/headroom/issues/610)) ([#612](https://github.com/xi-guan/headroom/issues/612)) ([18925b8](https://github.com/xi-guan/headroom/commit/18925b8c6e343c9d593891cd29ac27fee1cb9836))
* **copilot:** support subscription auth through Headroom ([ff4a0c6](https://github.com/xi-guan/headroom/commit/ff4a0c6bc64e5e68ab76c38047a36a3c7a6aaacf))
* **copilot:** use responses API for subscription reasoning models ([#647](https://github.com/xi-guan/headroom/issues/647)) ([84ac332](https://github.com/xi-guan/headroom/commit/84ac332d14dafacedc2f0b46f5ac6b3977b098d0))
* **core:** expose compress_openai_responses_live_zone via PyO3 (hot-fix c1/2) ([c48735d](https://github.com/xi-guan/headroom/commit/c48735d0298b94d25d40397ea64a2d66d1e557d0))
* **core:** F2.2 c1/3 — extend CompressionPolicy with three per-mode tuning fields ([797dc63](https://github.com/xi-guan/headroom/commit/797dc63da747dd8594958709271abd658de4a5c0))
* **core:** introduce CompressionPolicy struct + auth_mode mapping (F2.1 c1/6) ([8376630](https://github.com/xi-guan/headroom/commit/837663006254cde327e9c7f71b2ea5682f9b902e))
* correct preserved-entry index mapping in Gemini content round-trip ([#836](https://github.com/xi-guan/headroom/issues/836)) ([0ffe2b6](https://github.com/xi-guan/headroom/commit/0ffe2b6ea49e5c8d3bff5fe2c90873c71a95c457))
* correct tiktoken encoding for unknown gpt-4 model snapshots ([#552](https://github.com/xi-guan/headroom/issues/552)) ([0e551de](https://github.com/xi-guan/headroom/commit/0e551de9d81021bb7f0dde1857a2341408606969))
* **crusher:** bridge SmartCrusher row-drop hash to Python compression_store ([#389](https://github.com/xi-guan/headroom/issues/389)) ([e664f11](https://github.com/xi-guan/headroom/commit/e664f11260e997c9e643feec8b2cff27f127660f))
* **crusher:** bridge SmartCrusher row-drop hash to Python compression_store ([#389](https://github.com/xi-guan/headroom/issues/389)) ([a40d4a5](https://github.com/xi-guan/headroom/commit/a40d4a5f6d3183c94941a7ffe8c28bcb5d769792))
* **crusher:** shim __libc_single_threaded for glibc &lt; 2.32 + extend audit ([19a43f0](https://github.com/xi-guan/headroom/commit/19a43f0d52a0b406b1e0cae2804fe0e204b4dcba))
* **crusher:** shim __libc_single_threaded for glibc &lt; 2.32 + extend audit ([17d6207](https://github.com/xi-guan/headroom/commit/17d6207bf544ddb670236be67d4530c8913e735f))
* **crusher:** switch compression_store cache key from MD5 to SHA-256 (CodeQL [#395](https://github.com/xi-guan/headroom/issues/395)) ([af9e628](https://github.com/xi-guan/headroom/commit/af9e6282f89ff4fb2e0052fd58314d407997b7e6))
* **dashboard:** light-mode backgrounds + aligned savings tables ([#1064](https://github.com/xi-guan/headroom/issues/1064)) ([5eae32b](https://github.com/xi-guan/headroom/commit/5eae32ba47fd2e6479cbc1cef1ef4f2fb992fe15))
* **dashboard:** rebind hero tile to file-backed savings, add cross-process lock ([a8b62a7](https://github.com/xi-guan/headroom/commit/a8b62a77d9068372c55f70d74721f2a73774caf3))
* **dashboard:** stable 'Proxy $ Saved' hero tile under --workers &gt; 1 ([#481](https://github.com/xi-guan/headroom/issues/481)) ([fd73b88](https://github.com/xi-guan/headroom/commit/fd73b88368b22beeb586b8e1aa37fcd2afb12532))
* decode/encode owned config, state and template assets as UTF-8 ([2f1538a](https://github.com/xi-guan/headroom/commit/2f1538a641dd0e60a7be3de85646a70c4bf7e287))
* decode/encode owned config, state and template assets as UTF-8 (fixes [#533](https://github.com/xi-guan/headroom/issues/533)) ([92075b9](https://github.com/xi-guan/headroom/commit/92075b95af799951c90a305a08ec4e958473967a))
* **deps:** make litellm optional on Python 3.14 ([#956](https://github.com/xi-guan/headroom/issues/956)) ([#993](https://github.com/xi-guan/headroom/issues/993)) ([b2f04e4](https://github.com/xi-guan/headroom/commit/b2f04e4ef714fb6f2776ed95ee9157c34333e6c3))
* **deps:** move gunicorn to [proxy-prod] extra, add Windows guard ([#537](https://github.com/xi-guan/headroom/issues/537)) ([fa558c5](https://github.com/xi-guan/headroom/commit/fa558c5647a91562f4a8fba0271d27b02c8ae01f))
* **docker:** upgrade base images to Python 3.13 / debian13 ([e6bf7a0](https://github.com/xi-guan/headroom/commit/e6bf7a03fef8a9f2e4802d63afdafb40627c7ad9))
* **docker:** upgrade base images to Python 3.13 / debian13, drop digest pinning ([08a2197](https://github.com/xi-guan/headroom/commit/08a219708c97dcdc678483a0e6891306624a1fad))
* **docs:** bump next.js to 16.2.6 for GHSA-h64f-5h5j-jqjh (CVE-2026-44577) ([a6a09e6](https://github.com/xi-guan/headroom/commit/a6a09e6cfbe6962a70a6fb2e4bebeee80756e304))
* **docs:** mkdocs configuration to build with correct folder ([#543](https://github.com/xi-guan/headroom/issues/543)) ([5557944](https://github.com/xi-guan/headroom/commit/55579445f84c363219f45dc5358599a04d4263ed))
* **docs:** update brace-expansion to 5.0.6 to remediate GHSA-jxxr-4gwj-5jf2 (CVE-2026-45149) ([6eb6fb5](https://github.com/xi-guan/headroom/commit/6eb6fb5941adfbd056daa1689c3fa0c3755fd298))
* **docs:** update bun.lock to next 16.2.6 for GHSA-h64f-5h5j-jqjh (CVE-2026-44577) ([91e0937](https://github.com/xi-guan/headroom/commit/91e0937243c801fa5f1021b4c47debef2444650c))
* don't inject empty tools:[] when client omitted the tools field ([#772](https://github.com/xi-guan/headroom/issues/772)) ([574bbae](https://github.com/xi-guan/headroom/commit/574bbae2cbe2f20b3f0e12b421c25ac256712f0a))
* expose code-aware flag ([7d99a71](https://github.com/xi-guan/headroom/commit/7d99a71285b3b3ec5c475c0676aa1a4a0887fbe7))
* expose compression latency bottlenecks ([4e146b0](https://github.com/xi-guan/headroom/commit/4e146b0b5a12d1040bb8dddd88b3445fc6b2af87))
* expose compression latency bottlenecks ([e9cae01](https://github.com/xi-guan/headroom/commit/e9cae0131bfe0c3b6db9096b2c5604259bda673d))
* format Codex compression changes ([03d12fc](https://github.com/xi-guan/headroom/commit/03d12fc14039d64fc6b53507a28308177661ab41))
* format Kompress tests for ruff ([fc0cba7](https://github.com/xi-guan/headroom/commit/fc0cba7b48cf7cefbef1968f57527bdf5c2fe652))
* **gemini:** surface functionResponse payloads to waste-signal detection ([#897](https://github.com/xi-guan/headroom/issues/897)) ([9b0c840](https://github.com/xi-guan/headroom/commit/9b0c840dd7c181d6266b31cd16f493393ccc5c1a))
* harden Copilot API auth token handling ([#557](https://github.com/xi-guan/headroom/issues/557)) ([6b0c09f](https://github.com/xi-guan/headroom/commit/6b0c09ffd5f2ce18c4d2cfa6233feaf37d487ead))
* harden learn path handling across platforms ([9577ef8](https://github.com/xi-guan/headroom/commit/9577ef811b3f078959fe821b39304977877f6f09))
* harden learn path handling across platforms ([5ceca13](https://github.com/xi-guan/headroom/commit/5ceca13c656165209dacc35d1dc2cc0aebd1afe1))
* harden release gating and clarify pipx compatibility ([9492386](https://github.com/xi-guan/headroom/commit/9492386398408ae6652aab58966fb16f4f26c2c8))
* harden release gating and clarify pipx Python compatibility ([a7e1f93](https://github.com/xi-guan/headroom/commit/a7e1f931a5511294c1e3daa6992f72d195373677))
* **health:** readyz verifies upstream connectivity, not just process liveness ([#744](https://github.com/xi-guan/headroom/issues/744)) ([5dfb446](https://github.com/xi-guan/headroom/commit/5dfb446da1fb65002e0dea18a90210a2a026f0b3))
* ignore brackets inside JSON strings when splitting mixed content ([#553](https://github.com/xi-guan/headroom/issues/553)) ([bdcfc32](https://github.com/xi-guan/headroom/commit/bdcfc322da0c4cde69931d641cfa18c76ddb138b))
* **init:** guard persistent task startup ([#616](https://github.com/xi-guan/headroom/issues/616)) ([9252d85](https://github.com/xi-guan/headroom/commit/9252d852c5a4c716eb5438b8f438d50e59a55fef))
* **init:** normalize Windows hook paths to forward slashes ([#788](https://github.com/xi-guan/headroom/issues/788)) ([6ea6e31](https://github.com/xi-guan/headroom/commit/6ea6e31f09845b2ad5c8bae73bcf353f3b629188))
* **init:** suppress hook recovery output ([#760](https://github.com/xi-guan/headroom/issues/760)) ([b439599](https://github.com/xi-guan/headroom/commit/b4395993aecbb65b85a5b2479dfdb35ea243bf54))
* inject openai_base_url so Codex subscription (ChatGPT plan) routes through proxy ([f0b40f1](https://github.com/xi-guan/headroom/commit/f0b40f11d5dfdfa41debb069478f9ad283d753d6))
* inject openai_base_url so Codex subscription (ChatGPT plan) routes through proxy ([5c7a5b4](https://github.com/xi-guan/headroom/commit/5c7a5b4857e4259ff16d272b1ba0308f3ac45282))
* **learn:** claude-cli streams output with idle timeout ([#373](https://github.com/xi-guan/headroom/issues/373)) ([9bff575](https://github.com/xi-guan/headroom/commit/9bff5752bbd769902f249cdfde42bc53539afd02))
* **learn:** decode directory names with spaces in Windows project paths ([#997](https://github.com/xi-guan/headroom/issues/997)) ([#1027](https://github.com/xi-guan/headroom/issues/1027)) ([2d3701b](https://github.com/xi-guan/headroom/commit/2d3701b59e9ff8aedc2a282c4467f27ca2355d62))
* **learn:** decode Unix home dirs whose username contains '.', '-' or '_' ([211daae](https://github.com/xi-guan/headroom/commit/211daae25687901d1f893714d877b25606d0ef69))
* **learn:** decode Unix home dirs whose username contains '.', '-' or '_' ([491a8b3](https://github.com/xi-guan/headroom/commit/491a8b3a1b260f42f503b3553a04c578c18e1cc0))
* **learn:** finish gemini-flash-latest default model sweep ([982d01b](https://github.com/xi-guan/headroom/commit/982d01b9c996fd5fe26154dc2f94d567192f6ff6))
* **learn:** finish gemini-flash-latest default model sweep ([#532](https://github.com/xi-guan/headroom/issues/532)) ([d797366](https://github.com/xi-guan/headroom/commit/d7973665f4e2f40f2b3acadd0ec584609fb33c6c))
* **learn:** scan subagent and workflow transcripts ([#1045](https://github.com/xi-guan/headroom/issues/1045)) ([0ddd4ed](https://github.com/xi-guan/headroom/commit/0ddd4ed9e92fe898373036ba3be228f9afc3bc5a))
* log Codex ws cancellations safely ([62a1f23](https://github.com/xi-guan/headroom/commit/62a1f23b8864f9b0a82dbab6225514f73b7ada9d))
* make headroom wrap readiness probe timeout configurable for slow ML imports ([#581](https://github.com/xi-guan/headroom/issues/581)) ([163677b](https://github.com/xi-guan/headroom/commit/163677b405d7ca8a54d6d7c798bf6ead90da7880))
* make proxy upgrades version-aware ([2732ae7](https://github.com/xi-guan/headroom/commit/2732ae7d820451bafdefceb76513c4eba109b29b))
* make proxy upgrades version-aware ([ea1f608](https://github.com/xi-guan/headroom/commit/ea1f608e79d8809ff4d7d2428972fdb633a01918))
* **mcp:** auto-register headroom MCP server in wrap claude/codex and init -g ([d9d8972](https://github.com/xi-guan/headroom/commit/d9d8972ac4f51c0f018c470b8dba337cb959074d))
* **memory:** drop regex-based pref extraction; filter system-reminder noise (refs [#464](https://github.com/xi-guan/headroom/issues/464)) ([1139b21](https://github.com/xi-guan/headroom/commit/1139b21f2a9a39803bcc11b981c73890980508ee))
* **memory:** expose memory IDs in auto-tail + memory_list tool + ID-usage guidance ([f844f64](https://github.com/xi-guan/headroom/commit/f844f64840491d9a838be4b00a4ca6d9ff97adba))
* **memory:** expose memory IDs in auto-tail + memory_list tool + ID-usage guidance ([c62d45e](https://github.com/xi-guan/headroom/commit/c62d45eea826c661aa8ebf1f2c8aba8408ea6109))
* **memory:** per-project storage so projects can no longer bleed memories (refs [#462](https://github.com/xi-guan/headroom/issues/462)) ([f8ffdbf](https://github.com/xi-guan/headroom/commit/f8ffdbfe7369d49c23c67ca9a3c4668238aab508))
* **memory:** READ-ONLY framing + fail-closed unresolved-project fallback ([a178249](https://github.com/xi-guan/headroom/commit/a178249fc0af4a1b6f212decb4f6d2793d57fae8))
* **memory:** READ-ONLY framing + fail-closed unresolved-project fallback ([482f80e](https://github.com/xi-guan/headroom/commit/482f80e735f124ee6860f6854255c77170b862e7))
* **memory:** traffic_learner indexes system-reminder fragments as user preferences (refs [#464](https://github.com/xi-guan/headroom/issues/464)) ([0be0eed](https://github.com/xi-guan/headroom/commit/0be0eede9e09466e4ec0c0ee10b1d0aa317e0e73))
* narrow compressed type for mypy 1.14 in ContentRouter.compress ([05fe6c0](https://github.com/xi-guan/headroom/commit/05fe6c010222921103651ebc3f9f4715a0418780))
* **observability:** G3 remediation — bound cardinality + wire dead metrics ([2a717a9](https://github.com/xi-guan/headroom/commit/2a717a993ee99f9401f5cdf78a23dcecd7cb1a51))
* **observability:** RTK metrics + Rust observability (Phase H blocker) ([b36ad9f](https://github.com/xi-guan/headroom/commit/b36ad9fe1c6a488eb9ffbf0e8b38d989278cf8ef))
* **observability:** wire Phase G PR-G3 RTK + proxy metrics (H-blocker) ([5f264a5](https://github.com/xi-guan/headroom/commit/5f264a53292e292c9c56b837c2750d1a415b1ea9))
* **openclaw:** declare headroom_retrieve tool contract ([#947](https://github.com/xi-guan/headroom/issues/947)) ([7c8c909](https://github.com/xi-guan/headroom/commit/7c8c909c853a264c833c645403cbbb1894b91432))
* **parser:** detect waste signals in Anthropic tool_result content blocks ([#815](https://github.com/xi-guan/headroom/issues/815)) ([929698a](https://github.com/xi-guan/headroom/commit/929698af1030e5926f3766d7d6ac292d6e38437b))
* per-project memory storage so projects can no longer bleed memories (GH [#462](https://github.com/xi-guan/headroom/issues/462)) ([7694f05](https://github.com/xi-guan/headroom/commit/7694f050fe3b4d80c82903f17f38a93b4b3d670e))
* **policy:** correct warm-cache penalty in net_mutation_gain to (S + dT) ([#903](https://github.com/xi-guan/headroom/issues/903)) ([0632eba](https://github.com/xi-guan/headroom/commit/0632eba6c3bdf5b030d794d3dfefa3c29543d2e8))
* populate Codex WS dashboard performance metrics ([4279a7f](https://github.com/xi-guan/headroom/commit/4279a7f35349bde2b0361e9fe6e9f3a75adbf5de))
* PR-D4 native Vertex publisher path + ADC ([d3c70ac](https://github.com/xi-guan/headroom/commit/d3c70acea5d2d893e6490b293a6b2f931a57a1d3))
* PR-E1 + PR-E2 tool array sort + schema-key sort (Phase E) ([c8e0b36](https://github.com/xi-guan/headroom/commit/c8e0b367572d6c38dc4807955599e32b90248001))
* PR-E1 tool array deterministic sort (Phase E) ([4a3b76b](https://github.com/xi-guan/headroom/commit/4a3b76bcc879b3ba4a6a29096b5b50cb87d34f40))
* PR-E2 recursive JSON Schema key sort (Phase E) ([9112fed](https://github.com/xi-guan/headroom/commit/9112fed9379cfe43d31e935c9ac855116abd60f9))
* PR-E3 Anthropic cache_control auto-placement (Phase E) ([397c805](https://github.com/xi-guan/headroom/commit/397c805698d01da20256d651a92a17429327cf6a))
* PR-E3 Anthropic cache_control auto-placement (Phase E) ([8672d5c](https://github.com/xi-guan/headroom/commit/8672d5c32680c790bfb6c431c2d1a854fac6566b))
* PR-E4 OpenAI prompt_cache_key auto-injection (Phase E) ([2fc73d0](https://github.com/xi-guan/headroom/commit/2fc73d0f73241a937304a8b8d4e11c550945e6df))
* PR-E4 OpenAI prompt_cache_key auto-injection (Phase E) ([573543f](https://github.com/xi-guan/headroom/commit/573543fce7dcf461d8a65bbfde4a6f9a93cee351))
* PR-E6 cache-bust drift detector telemetry (Phase E) ([41ca054](https://github.com/xi-guan/headroom/commit/41ca0544c793731522a26a916bc351cc18a460bf))
* preserve Claude Code tool-search deferral through the proxy ([#746](https://github.com/xi-guan/headroom/issues/746)) ([#753](https://github.com/xi-guan/headroom/issues/753)) ([1c8c538](https://github.com/xi-guan/headroom/commit/1c8c538780d5c9a43781f1fdd9eeda2657280446))
* preserve Codex OAuth provider config ([7e29a60](https://github.com/xi-guan/headroom/commit/7e29a60b6feca5848ce1a07119294d45a472c04e))
* preserve Codex OAuth proxy delivery ([06428d2](https://github.com/xi-guan/headroom/commit/06428d20fd0514375024a6784b30b873a0f8d82d))
* **providers:** update DeepSeek V3 context limit from 128K to 1M ([#1038](https://github.com/xi-guan/headroom/issues/1038)) ([#1137](https://github.com/xi-guan/headroom/issues/1137)) ([bcabc5c](https://github.com/xi-guan/headroom/commit/bcabc5cb11c7c411ed29dac1fcc3771833ac8524))
* **proxy,dashboard:** correct savings reporting ([71348f4](https://github.com/xi-guan/headroom/commit/71348f407f5d3463165a44665bc48e40f7b29a69))
* **proxy,dashboard:** correct savings reporting for backend-routed traffic and drop broken Compression Quality widget ([6643266](https://github.com/xi-guan/headroom/commit/6643266ec02abbdb54cd2910b3a23845c144805f))
* **proxy:** add auth_mode_policy_enforcement feature flag (F2.1 c3/6) ([027b203](https://github.com/xi-guan/headroom/commit/027b203c2352693b53a54d9e7763cc61c19e2f20))
* **proxy:** add native Bedrock converse-stream route ([#917](https://github.com/xi-guan/headroom/issues/917)) ([b08ec15](https://github.com/xi-guan/headroom/commit/b08ec15b0d392b8b8cf93dbadaee4b7e6b465f1c))
* **proxy:** bound Codex Responses compression work ([160989c](https://github.com/xi-guan/headroom/commit/160989c43ecbe86d36c1c69681c578276c756285))
* **proxy:** F2.1 — per-auth-mode CompressionPolicy gates ([3b1ee2e](https://github.com/xi-guan/headroom/commit/3b1ee2e4af9eba4318e748d65be88bb04daef81c))
* **proxy:** F2.2 — per-mode CompressionPolicy tuning fields ([294df2b](https://github.com/xi-guan/headroom/commit/294df2b894a985c8501981de35865aa3245fbdc2))
* **proxy:** F4 — trust X-Forwarded-* only behind allow-listed gateway ([d10bd5f](https://github.com/xi-guan/headroom/commit/d10bd5f59c5a36e14f6c5f0480b821532521b753))
* **proxy:** F4 — trust X-Forwarded-* only behind allow-listed gateway ([665c082](https://github.com/xi-guan/headroom/commit/665c0823d96b461f6127debe2d19df4e91c7c918))
* **proxy:** fail-open on corrupt golden bytes instead of RuntimeError ([#603](https://github.com/xi-guan/headroom/issues/603)) ([2170a1b](https://github.com/xi-guan/headroom/commit/2170a1b4a00e9c46e845993c9b0f6cb2ef0c0684))
* **proxy:** hoist compression_policy outside is_token_mode branch (F2.1 c5 followup) ([708b87a](https://github.com/xi-guan/headroom/commit/708b87a19fbe0c71ab5945ef8fda154f0abd2eef))
* **proxy:** hot-fix Codex /v1/responses compression via PyO3 inline call ([1a3098a](https://github.com/xi-guan/headroom/commit/1a3098a48f8021e00c1fb118b1a5dab0b8add559))
* **proxy:** inline WebSocket /v1/responses compression via PyO3 ([1050e00](https://github.com/xi-guan/headroom/commit/1050e00241960e475e63badd59c175abc5b3e7cf))
* **proxy:** inline WebSocket /v1/responses compression via PyO3 ([4a50313](https://github.com/xi-guan/headroom/commit/4a503135487182523a9db559cff23cd42427ca64))
* **proxy:** keep codex image-generation WS turns alive through the relay ([#1000](https://github.com/xi-guan/headroom/issues/1000)) ([7dbbb40](https://github.com/xi-guan/headroom/commit/7dbbb4077e7bb11b3da4634573cfc1d998e139ec))
* **proxy:** lazy-import server to avoid fastapi crash ([#442](https://github.com/xi-guan/headroom/issues/442)) ([93c6937](https://github.com/xi-guan/headroom/commit/93c69372e614f2b04873bed75602a88d2256a7fc))
* **proxy:** make budget enforcement actually work ([#885](https://github.com/xi-guan/headroom/issues/885)) ([a14ab45](https://github.com/xi-guan/headroom/commit/a14ab45cf0e6e698c52a0efd0448ca7c8ba0b31f))
* **proxy:** make CCR multi-worker warning conditional on backend ([#770](https://github.com/xi-guan/headroom/issues/770)) ([d76a729](https://github.com/xi-guan/headroom/commit/d76a7296df121365d74c415b8c702a3ad80abd30))
* **proxy:** make Kompress eager preload cache-only so a cold cache can't block startup ([#783](https://github.com/xi-guan/headroom/issues/783)) ([841663d](https://github.com/xi-guan/headroom/commit/841663da16971b1e0d8e204fdf18e4bafedaf9e0))
* **proxy:** MemoryDecision contract + 3 bypass bugs + drop 500-char query cap ([4e1b218](https://github.com/xi-guan/headroom/commit/4e1b21854456431253952ec4d32b8464133cc667))
* **proxy:** MemoryDecision contract + 3 bypass bugs + drop 500-char query cap ([71d5a7b](https://github.com/xi-guan/headroom/commit/71d5a7b5455f92bd07c1cfc95909738687672307))
* **proxy:** plumb CompressionPolicy through proxy + dispatchers (F2.1 c2/6) ([948c8f2](https://github.com/xi-guan/headroom/commit/948c8f2069c6c88eaba40196f2235cd279e2064f))
* **proxy:** PR-D4 native Vertex publisher path + ADC bearer auth ([c10a219](https://github.com/xi-guan/headroom/commit/c10a2195afdf86e0ade17fad53a509de577224d4))
* **proxy:** read RTK gain stats globally by default ([#957](https://github.com/xi-guan/headroom/issues/957)) ([b70fccb](https://github.com/xi-guan/headroom/commit/b70fccbe174e1adff0f52ceaf9bec0dcda0c73da))
* **proxy:** record cache reads/writes on backend-routed streaming ([#327](https://github.com/xi-guan/headroom/issues/327)) ([7ddc0ce](https://github.com/xi-guan/headroom/commit/7ddc0cef1eb7b58021fcb57f6c2a7f00a6f090c7))
* **proxy:** record cache reads/writes on backend-routed streaming ([#327](https://github.com/xi-guan/headroom/issues/327)) ([3e97a0c](https://github.com/xi-guan/headroom/commit/3e97a0cb73a5801496dc1ae2dab9e81788d87b2a))
* **proxy:** recover SSE usage from truncated final event ([b166bd3](https://github.com/xi-guan/headroom/commit/b166bd3d6a9b50925bd0fee5dedce704666ee35e))
* **proxy:** recover SSE usage from truncated final event ([d91254a](https://github.com/xi-guan/headroom/commit/d91254a0f2419dbd77e6b8f3b6718a029b725082))
* **proxy:** remove invalid savings tracker flock ([0d8de25](https://github.com/xi-guan/headroom/commit/0d8de25bfc346da572fecabf86580415e3939341))
* **proxy:** restore Codex usage headers on WS and streaming SSE transports ([#577](https://github.com/xi-guan/headroom/issues/577)) ([#794](https://github.com/xi-guan/headroom/issues/794)) ([0ce68de](https://github.com/xi-guan/headroom/commit/0ce68dedd770d5411d16abe30e5ea9dd0b7d8eee))
* **proxy:** route Claude Code model metadata to Anthropic ([#627](https://github.com/xi-guan/headroom/issues/627)) ([30c1ac8](https://github.com/xi-guan/headroom/commit/30c1ac8656bcc3d11755daef8d1d27cd8770ebc7))
* **proxy:** rustfmt drift in live_zone_anthropic imports (F2.1 c2 followup) ([0546795](https://github.com/xi-guan/headroom/commit/05467955479d9578934a956c29581997d12a1b16))
* **proxy:** stamp X-Client: codex on Responses endpoint for unidentified callers ([#1036](https://github.com/xi-guan/headroom/issues/1036)) ([b0cd032](https://github.com/xi-guan/headroom/commit/b0cd0329c75c8556c51c1c96dc19f2ab6a23677d))
* **proxy:** Strands MCP bundle + backend path fixes + Codex fail-closed protection ([20dc1f2](https://github.com/xi-guan/headroom/commit/20dc1f28f3ccadbc2d1109d73b5bfe875eb81c47))
* **proxy:** surface CompressionDecision.passthrough_reason in tags ([88983ad](https://github.com/xi-guan/headroom/commit/88983ad34efef0556be9baeb1dd57397e4e6d724))
* **proxy:** surface CompressionDecision.passthrough_reason in tags ([e4e28b6](https://github.com/xi-guan/headroom/commit/e4e28b65f459df6879b38384842faaeba6357a2a))
* **proxy:** thread tags into 13 outcome sites + synth /v1/models + free-fn _extract_tags ([3ec5492](https://github.com/xi-guan/headroom/commit/3ec549288aed46dc46067b6dc55f287a8b19d218))
* **proxy:** thread tags into 13 outcome sites; synthesize /v1/models for ChatGPT auth ([6d62985](https://github.com/xi-guan/headroom/commit/6d62985b73b4a9e50d13ee9fc3df4b62bcba1c14))
* **proxy:** treat NODE_EXTRA_CA_CERTS as additive, not replacement ([#998](https://github.com/xi-guan/headroom/issues/998)) ([#1031](https://github.com/xi-guan/headroom/issues/1031)) ([c987283](https://github.com/xi-guan/headroom/commit/c98728363a1079f39bb19da2955cc859b35900a8))
* **proxy:** unblock Codex WS compression — delete inner-pool + global semaphore ([6cf8f7f](https://github.com/xi-guan/headroom/commit/6cf8f7f44abf82b5a34572ead0b6ee0bf523a6ce))
* **proxy:** unblock Codex WS compression — delete inner-pool + global semaphore ([a167f5c](https://github.com/xi-guan/headroom/commit/a167f5cc299ae78ce94cc6ddc3694af26c5c408b))
* **proxy:** wire CompressionPolicy through handlers + flip default enabled (F2.1 c5/5) ([0fef428](https://github.com/xi-guan/headroom/commit/0fef428f1fecff6a72a355098457bacc6465ef5f))
* **proxy:** wire PyO3 compression into /v1/responses handler (hot-fix c2/2) ([c0baaf0](https://github.com/xi-guan/headroom/commit/c0baaf052f18b2561226d20de6b182bb14300416))
* re-enable Codex /v1/responses compression + fix prose-format over-freeze ([7aaa4ac](https://github.com/xi-guan/headroom/commit/7aaa4ac48fcada1dc8e44477dc8256153d75093b))
* register serena mcp during wrap ([44231f6](https://github.com/xi-guan/headroom/commit/44231f68cd8bbbd010defdba2fb919bf49bafc89))
* register serena mcp during wrap ([a7160f7](https://github.com/xi-guan/headroom/commit/a7160f7eab87813f065ab398692231398c221b87))
* **release:** tag format vX.Y.Z (drop release-please component prefix) ([4a39ef5](https://github.com/xi-guan/headroom/commit/4a39ef54ed6cdaa24d8f9fa49bbd3daf7100658e))
* **release:** tag format vX.Y.Z (drop release-please component prefix) ([0f3e3af](https://github.com/xi-guan/headroom/commit/0f3e3af6b2a154c5ecaeda3f9770cec97e9a3ba0))
* remove env_key from injected Codex provider — fixes [#393](https://github.com/xi-guan/headroom/issues/393) ([7fb6d7f](https://github.com/xi-guan/headroom/commit/7fb6d7fefdce6145a39485b0c7d3227bdd573530))
* route v1internal code assist requests to cloudcode-pa.googleapis… ([#821](https://github.com/xi-guan/headroom/issues/821)) ([e20f16b](https://github.com/xi-guan/headroom/commit/e20f16b1a65710f532aa019ef60ac7a18a4e7f46))
* schema compaction must not drop property names that match DROP_KEYS ([#785](https://github.com/xi-guan/headroom/issues/785)) ([ae2122f](https://github.com/xi-guan/headroom/commit/ae2122fda8ff0efc03d609d27270453fea3a8718))
* **security:** block DNS-rebinding on /debug/* and /stats/reset via Host-header allowlist ([#605](https://github.com/xi-guan/headroom/issues/605)) ([b4b5025](https://github.com/xi-guan/headroom/commit/b4b50253f16d0a30f1d17a959753137e997efbac))
* **security:** patch loopback guard, retry None raise, async subprocess, and cache race ([06d7cb9](https://github.com/xi-guan/headroom/commit/06d7cb9e6c011711a478864a970f7c87ee853a97))
* **security:** patch loopback guard, retry None raise, blocking subprocess, and cache stats race ([78f3a4d](https://github.com/xi-guan/headroom/commit/78f3a4dd3e8e26525822a3c830d576d702dfed8b))
* **serena:** stop the Serena dashboard popup and make --no-serena actually disable Serena ([#1003](https://github.com/xi-guan/headroom/issues/1003)) ([919379a](https://github.com/xi-guan/headroom/commit/919379a8a1731a0002d813a79d880ad35f8bbbc9))
* ship glibc 2.38 compat shim + wheel symbol audit (closes [#355](https://github.com/xi-guan/headroom/issues/355)) ([6793adb](https://github.com/xi-guan/headroom/commit/6793adb003e1efb8ba6a6446a7829de2602a266f))
* ship glibc 2.38 compat shim + wheel symbol audit (closes [#355](https://github.com/xi-guan/headroom/issues/355)) ([e214672](https://github.com/xi-guan/headroom/commit/e2146724af09801c8f75dcd357d1a61c91d6bbb0))
* sort anthropic handler imports ([8f6a9cf](https://github.com/xi-guan/headroom/commit/8f6a9cfb26b480593a7e42e4ecd076fa74c4fc2a))
* speed up Kompress inference ([98f73e3](https://github.com/xi-guan/headroom/commit/98f73e3502c62dbc2c4119dcc68ef27537cc8f58))
* **ssl:** upstream httpx client inherits SSL_CERT_FILE, REQUESTS_CA_BUNDLE, NODE_EXTRA_CA_CERTS ([#745](https://github.com/xi-guan/headroom/issues/745)) ([e50fbb3](https://github.com/xi-guan/headroom/commit/e50fbb3e0d61d561456d7b0ff9e0a8ee106a2f02))
* stabilize codex compression, stats, and proxy lifecycle ([eaf5980](https://github.com/xi-guan/headroom/commit/eaf5980b4ac48c909a1fa2ef1ace460752ec0918))
* stabilize learn write-failure worker test ([155c069](https://github.com/xi-guan/headroom/commit/155c0691767d68f7ec5b47de476f8215946901bf))
* **startup:** move HF/httpx log suppression before sentence_transformers init ([#622](https://github.com/xi-guan/headroom/issues/622)) ([176d4c7](https://github.com/xi-guan/headroom/commit/176d4c772a7ca8c9da58ca2403f890ba85e8bad8))
* **startup:** suppress proxy startup log noise ([#619](https://github.com/xi-guan/headroom/issues/619)) ([4555901](https://github.com/xi-guan/headroom/commit/45559011b16a2e084dda22c675c819a4789f961d))
* **subscription:** address G2 review findings — phantom delta, multi-worker race, silent fallbacks ([f68090c](https://github.com/xi-guan/headroom/commit/f68090c5b4bd9670ee7fc9a0c71e57f05072c18c))
* **subscription:** wire tokens_saved_rtk data plane ([c7d1247](https://github.com/xi-guan/headroom/commit/c7d1247a2bd06738c3b6c8e73e15902a7e428467))
* **subscription:** wire tokens_saved_rtk from RTK stats endpoint ([44c605f](https://github.com/xi-guan/headroom/commit/44c605fbb0e3ae4e7a92d9693d0da8bc21115b81))
* support Copilot Business subscription auth ([#641](https://github.com/xi-guan/headroom/issues/641)) ([0b4a4bd](https://github.com/xi-guan/headroom/commit/0b4a4bd4830ecec1bca64c2f62455c4c923d91df))
* suppress LiteLLM provider banner before import ([#874](https://github.com/xi-guan/headroom/issues/874)) ([f9384ef](https://github.com/xi-guan/headroom/commit/f9384ef4b780eaa1d8ca6dcc314ad430b87f524a))
* sync Codex MCP proxy config during wrap ([ac1d11c](https://github.com/xi-guan/headroom/commit/ac1d11c9a2a946ad5362db106cf9094262b7329a))
* **telemetry:** honour HEADROOM_TELEMETRY=off in /v1/telemetry collector ([218821e](https://github.com/xi-guan/headroom/commit/218821e4897dfcb78382b95330fc69cd08d9ccc1))
* **telemetry:** honour HEADROOM_TELEMETRY=off in /v1/telemetry collector ([#390](https://github.com/xi-guan/headroom/issues/390)) ([9ddbdf2](https://github.com/xi-guan/headroom/commit/9ddbdf2313eb4a77ad6cff3a0ae5eb0264cf7c57))
* **tests:** drive RTK subprocess failure with real exec, not monkeypatched run ([9b6d637](https://github.com/xi-guan/headroom/commit/9b6d6374f13a88842a1944688005649ad3680acd))
* **tests:** make codex scheduler stress test machine-independent ([f82d61b](https://github.com/xi-guan/headroom/commit/f82d61b1636cfa7d75aeca01f32df070cff3318d))
* **tests:** make stress test CI-robust — uniform frame sizes, tighter ratio ([c22342e](https://github.com/xi-guan/headroom/commit/c22342e1c7e909b3270d19fbaa5583b91a166952))
* **tests:** mock logger.warning directly instead of relying on caplog ([c38dac3](https://github.com/xi-guan/headroom/commit/c38dac301e6bc702979ab11357a9c27a180ae060))
* **tests:** patch headroom.rtk.get_rtk_path, not the helpers alias ([317dffe](https://github.com/xi-guan/headroom/commit/317dffe58fb0c6233210bbc9e42ebf16b9288391))
* **tests:** ship scripts/replay_codex_ws_load.py so CI can import it ([e532763](https://github.com/xi-guan/headroom/commit/e53276302ef9585be37519b16eb94513242372e7))
* **tests:** tomllib fallback to tomli on python 3.10 ([74843d1](https://github.com/xi-guan/headroom/commit/74843d1d626de70158a359661a540c615ef1a6c5))
* **tests:** update CacheAligner detector-only tests for F2.2 5-field CompressionPolicy ([be5d9f7](https://github.com/xi-guan/headroom/commit/be5d9f7baaf11d706afecf7c0ca0b9da984f38a2))
* **tests:** widen wrap-e2e openclaw startup timeout from 5s to 30s ([2ae88a6](https://github.com/xi-guan/headroom/commit/2ae88a6874b19ec9c4173b5a41e4f09918d2a348))
* **tests:** widen wrap-e2e openclaw startup timeout to 30s ([2febf1b](https://github.com/xi-guan/headroom/commit/2febf1bbbfd0e2d7fde438afff93b9e2e9c9d093))
* **transforms:** F2.2 c2/3 — wire toin_read_only gate + extend policy_selected log ([5b38cbf](https://github.com/xi-guan/headroom/commit/5b38cbf8a79d146adb6ca2ee25974bc35e271b05))
* **transforms:** Python parity port of CompressionPolicy + cache_aligner gate (F2.1 c4/5) ([de8e245](https://github.com/xi-guan/headroom/commit/de8e245990399442145a2aa5a8fe61eb4ddb3a76))
* **transforms:** use thread-local tree-sitter parsers to prevent pyo3 Unsendable panic ([#604](https://github.com/xi-guan/headroom/issues/604)) ([2ad300a](https://github.com/xi-guan/headroom/commit/2ad300aff801838efe5649b00a0396523a401a2a))
* update dashboard doc link ([#544](https://github.com/xi-guan/headroom/issues/544)) ([378d77e](https://github.com/xi-guan/headroom/commit/378d77e79d0020ca7fba3de8df7aaf910056ad2a))
* Update Next.js to 16.2.4 in docs/bun.lock to address GHSA-gx5p-jg67-6x7h (CVE-2026-44580) ([0b9f11a](https://github.com/xi-guan/headroom/commit/0b9f11a223bb6e6a6c1660ff1dfc1df6d67dfa84))
* Update Next.js to 16.2.6 in docs/package.json and package-lock.json to address GHSA-h64f-5h5j-jqjh (CVE-2026-44577) ([db5d15f](https://github.com/xi-guan/headroom/commit/db5d15f99e71b69a369eb9c161e04dbffb9b5d4a))
* Upgrade litellm to 1.86.2 to remediate CVE-2026-42271 ([07581b9](https://github.com/xi-guan/headroom/commit/07581b9e8075b833a6b543149008547260fe9dc0))
* use thread-local tree-sitter parsers to prevent unsendable panic ([38aefc1](https://github.com/xi-guan/headroom/commit/38aefc1d34e65beec46f0b8cb0ff43028de38cbb))
* **vertex,bedrock:** remove dead handle_raw_predict, honour X-Forwarded-Proto, cap Bedrock body size ([c6ecdc4](https://github.com/xi-guan/headroom/commit/c6ecdc429923872a9821e2e191da4990d41e8ad4))
* **vertex,bedrock:** remove dead handle_raw_predict, honour X-Forwarded-Proto, cap Bedrock body size ([28b2bac](https://github.com/xi-guan/headroom/commit/28b2bacdf6ffebb1c2bfa81ea80a3862f8ef0e24))
* Windows ORT builds and Docker signing retries ([5cc3fd4](https://github.com/xi-guan/headroom/commit/5cc3fd4852337b64e635b33d9a490e0931e46cef))
* wire HEADROOM_EXCLUDE_TOOLS / HEADROOM_TOOL_PROFILES into Click proxy entrypoint ([#943](https://github.com/xi-guan/headroom/issues/943)) ([9b7b436](https://github.com/xi-guan/headroom/commit/9b7b436b04118d6ec4dcaebafc1c82e03e786f27))
* **wrap:** avoid duplicate top-level keys when injecting codex provider ([#884](https://github.com/xi-guan/headroom/issues/884)) ([dd22cfd](https://github.com/xi-guan/headroom/commit/dd22cfd72ad9265c25a95ef5536dc3d17e85dbbf))
* **wrap:** percent-encode non-ASCII cwd names in X-Headroom-Project header ([#1071](https://github.com/xi-guan/headroom/issues/1071)) ([9f712cc](https://github.com/xi-guan/headroom/commit/9f712ccbd7ec27b74f6ac7f20b7d2a9743dba1d8))
* **wrap:** report unbindable proxy ports ([#602](https://github.com/xi-guan/headroom/issues/602)) ([6dfcaa8](https://github.com/xi-guan/headroom/commit/6dfcaa839f1175518e378963c79cc7bd3ceb7946))
* **wrap:** track shared proxy clients with markers ([#877](https://github.com/xi-guan/headroom/issues/877)) ([05bd56b](https://github.com/xi-guan/headroom/commit/05bd56bcb6b103fab5522da2b14295cf7bd8dbc1))
* **wrap:** write env.ANTHROPIC_BASE_URL to settings.json so daemon-spawned conversations inherit proxy ([#951](https://github.com/xi-guan/headroom/issues/951)) ([#1078](https://github.com/xi-guan/headroom/issues/1078)) ([a554c3a](https://github.com/xi-guan/headroom/commit/a554c3a0e6c5c57a7c745d8648024362d9d502a4))


### Code Refactoring

* **cli:** factor shared wrap-subcommand scaffolding ([8eeb926](https://github.com/xi-guan/headroom/commit/8eeb9261680dd071654a87204521ccd3703ef77d))
* **cli:** factor shared wrap-subcommand scaffolding ([c74ad11](https://github.com/xi-guan/headroom/commit/c74ad113a4ced9968e45cad1077e6a020dc6a401))
* DRY cache logic, add thread safety, fix Bash exclusion ([#704](https://github.com/xi-guan/headroom/issues/704)) ([e36fccd](https://github.com/xi-guan/headroom/commit/e36fccd8cfe6b963398d3d0fa1637a45bd6421af))
* extract litellm model resolution to shared utility ([ec7d006](https://github.com/xi-guan/headroom/commit/ec7d0065cc5055e504e79cf24f3951e404fe4cb9))
* extract litellm model resolution to shared utility ([896a093](https://github.com/xi-guan/headroom/commit/896a0933998c6dda4fcae44cc194ab2770e6f9d6))
* **proxy:** collapse 3 stream finalizers onto RequestOutcome.from_stream ([af50390](https://github.com/xi-guan/headroom/commit/af503905b584e61eac37d14e290b3033074ffc24))
* **proxy:** collapse 3 stream finalizers onto RequestOutcome.from_stream ([694589f](https://github.com/xi-guan/headroom/commit/694589fec4997ae60118aa3609672a9ed3262a8f))
* **proxy:** CompressionDecision contract + 4 missing-gate bug fixes ([1699435](https://github.com/xi-guan/headroom/commit/1699435ddfd10f3918fcd18e1fdcfc6b232ebdad))
* **proxy:** introduce RequestOutcome funnel; collapse 3 streaming finalizers ([3762f63](https://github.com/xi-guan/headroom/commit/3762f6375ca7a93301f6c3b946f6b1cefb9ca87d))
* **proxy:** introduce RequestOutcome funnel; collapse 3 streaming finalizers ([e898f68](https://github.com/xi-guan/headroom/commit/e898f68b89fcf3dd6cd5d7ee199e9f032d4fb20a))
* **proxy:** MemoryRanker + ImageCompressionDecision + branch-aware version-sync ([c79aa22](https://github.com/xi-guan/headroom/commit/c79aa22be798a40e19c24cfc3e33427cdd84dc29))
* **proxy:** MemoryRanker + ImageCompressionDecision + branch-aware version-sync ([a7b197c](https://github.com/xi-guan/headroom/commit/a7b197c6eca08e0080cb04bc19859026233c5603))
* **proxy:** migrate Codex WS + OpenAI HTTP + batch handlers; delete Databricks ([993c907](https://github.com/xi-guan/headroom/commit/993c9076f92558402c5f925a685fde4001f96daf))
* **proxy:** migrate Gemini + Anthropic non-streaming onto outcome funnel ([7aca004](https://github.com/xi-guan/headroom/commit/7aca00445e23f421d1c8c278bf720cab046da20f))
